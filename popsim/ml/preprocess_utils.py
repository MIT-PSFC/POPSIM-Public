...
def shift_time_to_not_nan(
    ds: xr.Dataset, episode_dim: str, time_dim: str, how: str = "any", subset: typing.Optional[typing.Iterable[typing.Hashable]] = None
) -> xr.Dataset:
    ...
    def dropna_preserve_size(group):
        ...
        time_of_first_cleaned_slice = cleaned_group[time_dim].values[0]
        time_index = np.where(group[time_dim].values == time_of_first_cleaned_slice)[0][0]
        n_shift = -time_index
