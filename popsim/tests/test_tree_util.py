...
sample_tree_1 = {
    'a': [1, 2, 3],
    'b': {'c': 'hello', 'd': [4.5, 6.7], 'comb_cases': ptypes.CombinatorialCases(cases={"a": 4, "b": [5, 6]})},
    'e': 42
}
...
sample_tree_2 = [
    ...
    {'a': 4, 'b': '5', 'c': [6, '7']},
    8,
    ptypes.MultiCases(cases={"foo": [1, 2, 3], "bar": PRNGModule.State(seed=42)}),
]
...
@pytest.mark.parametrize("tree, type_, expected", [
    ...
    (sample_tree_1, ptypes.CombinatorialCases, [sample_tree_1["b"]["comb_cases"]]),
    (sample_tree_1, complex, []),
    (sample_tree_2, ptypes.MultiCases, [sample_tree_2[3]]),
