...
from popsim.ml.dataloading import make_dataloader, make_time_indep_dataloader, XarrayDataset
import numpy as np
...
def _run_dl_checks(dl, batch_size, expected_n_samps, shuffle, segment_length = None):
    ...
    # For each batch, check it is an XarrayDataset and that the sizes are correct.
    first_batches = []
    for idx, batch in enumerate(dl):
        assert isinstance(batch, XarrayDataset)
