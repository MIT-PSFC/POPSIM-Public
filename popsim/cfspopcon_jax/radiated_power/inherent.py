...
def calc_bremsstrahlung_radiation(
    ...
    Args:
        ...
        volume_integrator: [m^3] :term: function to integrate over the plasma volume.
    ...
    Kb = volume_integrator(fKb)  # radial profile factor
...
def calc_synchrotron_radiation(
    ...
    P_sync = volume_integrator(P_sync_r)
    return P_sync
    P_sync = volume_integrator(P_sync_r)
    return P_sync
