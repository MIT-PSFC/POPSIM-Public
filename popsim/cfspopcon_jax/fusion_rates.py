...
from .fusion_reaction_data import ENERGY, SIGMAV, ReactionType
...
def calc_fusion_power(
    ...
    Args:
        ...
        nfuel19_profile: [1e19 m^-3] ion fuel density profile
        rho: [~] :term:`glossary link<rho>`
        plasma_volume: [m^3] :term:`glossary link<plasma_volume>`

    Returns:
        :term:`P_fusion` [MW], :term:`P_neutron` [MW], :term:`P_alpha` [MW], :term `reaction_rate` [1/s]
    """
    ...
    return total_fusion_power_MW, fusion_power_to_neutral_MW, fusion_power_to_charged_MW, total_fusion_power_MW / reaction_at_Ti[1]
...
def _calc_fusion_reaction_rate(
    ...
    (
        ...
        sigmav=sigmav,
        heavier_fuel_species_fraction=heavier_fuel_species_fraction,  # type:ignore[call-arg]
    )
...
def _integrate_power(
    ...
    Args:
        ...
        volume_integrator: function to integrate over the plasma volume.

    Returns:
         power [MW]
    """
    power_density_MW_per_m3 = power_density_factor_MW_m3 * fuel_density_per_m3 * fuel_density_per_m3
    power_MW = volume_integrator(power_density_MW_per_m3)
