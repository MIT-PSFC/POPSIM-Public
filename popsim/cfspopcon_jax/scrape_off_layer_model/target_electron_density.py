...
def calc_target_electron_density(
    target_electron_density_basic: Quantity | xr.DataArray,
    f_vol_loss_target_electron_density: float | xr.DataArray,
    f_other_target_electron_density: float | xr.DataArray,
