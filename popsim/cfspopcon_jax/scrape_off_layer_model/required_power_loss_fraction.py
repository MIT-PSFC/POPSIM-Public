...
def calc_required_SOL_power_loss_fraction(
    ...
    """
    required_SOL_power_loss_fraction = 1.0 - np.sqrt(
        required_target_electron_temp / target_electron_temp_basic * (1.0 - SOL_momentum_loss_fraction) ** 2 / f_other_target_electron_temp
    )
